...
#define ERROR 0
typedef int Status;
Status wrin2s(FILE *out,double R[Md][Mt],double Z[Md][Mt],double D[Md][Mt],double U[Md][Mt],double P[Md][Mt],double Gamma[Md][Mt],double t)//for mesh
{
...
Status StarPU(double &P,double &U,double &DML,double &DMR,double DL,double DR,double UL,double UR,double PL,double PR,double CL,double CR,double GammaL, double GammaR)
...
Status AcousticSLagTan(double &DtP,double DU,double D,double U,double C_star,double r)
